...
(function(){
  const dict = {
    en: {
      ...
      "hero.badge":"Spiritual Community",
      "hero.title":"VIVEK",
      ...
      "about.worship.body":"Experience uplifting worship services that inspire and strengthen your faith. Our community gathers to celebrate, pray, and grow closer to the divine.",
    ...
    bn: {
      ...
      "hero.badge":"আধ্যাত্মিক সম্প্রদায়",
      "hero.title":"বিবেক",
      ...
      "contact.visit.title":"আমাদের ঠিকানা","contact.visit.addr":"১২৩ ফেইথ স্ট্রিট<br>কমিউনিটি সিটি, ST ১২৩৪৫",
      "contact.call.title":"ফোন","contact.call.num":"(123) 456-7890",
      "contact.email.title":"ইমেইল","contact.email.addr":"info@faithcenter.org",
      "contact.hours.title":"অফিস সময়","contact.hours.value":"সোমবার - শুক্রবার<br>সকাল ৯টা - বিকাল ৫টা",
